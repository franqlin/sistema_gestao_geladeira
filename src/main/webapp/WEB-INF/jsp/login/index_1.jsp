        ...
        <div class="navbar navbar-fixed-top">
            <div class="navbar-inner">
                <div class="container-fluid">
                    ...
                    <a class="brand" href="#">Sistema de Gest&amacr;o SGG</a>
                        ...
                        <ul class="nav pull-right">
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="divider"></li>
                                    <li>
                                        <a tabindex="-1" href="${pageContext.request.contextPath}/logout">Sair</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                        <ul class="nav">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu" id="menu1">
                                    <li>
                                        <a href="#">Usu&aacute;rios <i class="icon-arrow-right"></i>
                                        </a>
                                        <ul class="dropdown-menu sub-menu">
                                            <li>
                                                <a href="#">Relat&oacute;rio</a>
                                            </li>
                                            <li>
                                                <a href="#">Logs</a>
                                            </li>
                            ...
                            <li class="dropdown">
                                <a href="#" role="button" class="dropdown-toggle" data-toggle="dropdown">Recursos Humanos<i class="caret"></i>

                                </a>
                                <ul class="dropdown-menu">
                                    <li>
                                        <a tabindex="-1" href="#">Lista de Usuário </a>
                                    </li>
                                    <li>
            ...
            <div class="row-fluid">
                <div class="span3" id="sidebar">
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
                        ...
                        <li>
                            <a href="calendar.html"><i class="icon-chevron-right"></i> Calend&aacute;rio</a>
                        </li>
                        <li>
                            <a href="stats.html"><i class="icon-chevron-right"></i> Estatisticas</a>
                        </li>
                        <li>
                            <a href="form.html"><i class="icon-chevron-right"></i> Formul&aacute;rio</a>
                        </li>
                        <li>
                            <a href="tables.html"><i class="icon-chevron-right"></i> Planilhas</a>
                        </li>
                        <li>
                ...
                <div class="span9" id="content">
                    <div class="row-fluid">
                        <div class="alert alert-success">
                            ...
                            <h4>Success</h4>
                            Bem vindo ao Sistema de Gest&amacr;o de Geladeira
                        </div>
                        	<div class="navbar">
                            	<div class="navbar-inner">
	                                <ul class="breadcrumb">
	                                    ...
	                                    <li>
                                                <a href="#">Configura&ccedil;&aacute;o</a> <span class="divider">/</span>	
	                                    </li>
