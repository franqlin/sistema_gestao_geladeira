                        ...
                        <ul class="nav">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu" id="menu1">
                                    <li>
                                        <a href="#">Ferramentas <i class="icon-arrow-right"></i>

                                        </a>
                                        <ul class="dropdown-menu sub-menu">
                                            <li>
                                                <a href="#">Relat&oacute;</a>
                                            </li>
                                            <li>
                                                <a href="#">Logs</a>
                                            </li>
                            ...
                            <li class="dropdown">
                                <a href="#" role="button" class="dropdown-toggle" data-toggle="dropdown">Usu&aacute;io <i class="caret"></i>
